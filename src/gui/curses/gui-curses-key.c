...
gui_key_default_bindings (int context)
{
    ...
    if (context == GUI_KEY_CONTEXT_DEFAULT)
    {
        ...
        BIND(/* m-^K          */ "meta-ctrl-K",        "/input delete_end_of_input");
        BIND(/* m-r           */ "meta-r",             "/input delete_input");
        BIND(/* m-R           */ "meta-R",             "/input delete_line");
        BIND(/* ^T            */ "ctrl-T",             "/input transpose_chars");
        BIND(/* ^U            */ "ctrl-U",             "/input delete_beginning_of_line");
        BIND(/* m-^U          */ "meta-ctrl-U",        "/input delete_beginning_of_input");
        ...
        BIND(/* s-<home>      */ "meta2-1;2H",         "/input move_beginning_of_input");
        BIND(/* s-<home>      */ "meta2-7$",           "/input move_beginning_of_input");
        ...
        BIND(/* s-<end>       */ "meta2-1;2F",         "/input move_end_of_input");
        BIND(/* s-<end>       */ "meta2-8$",           "/input move_end_of_input");
        ...
        BIND(/* s-<up>        */ "meta2-a",            "/input move_previous_line");
        BIND(/* s-<up>        */ "meta2-1;2A",         "/input move_previous_line");
        BIND(/* s-<down>      */ "meta2-b",            "/input move_next_line");
        BIND(/* s-<down>      */ "meta2-1;2B",         "/input move_next_line");
