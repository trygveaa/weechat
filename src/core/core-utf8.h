...
extern int unicode_strlen (const char *string, int *size_screen);
extern int unicode_character_size (const char *string, int *size_screen);
extern int unicode_strlen_screen (const char *string);
